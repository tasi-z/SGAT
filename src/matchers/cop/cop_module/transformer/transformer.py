...
class LocalFeatureTransformer(nn.Module):
    ...
    def forward(self, feat0, feat1, mask0=None, mask1=None, data=None):
        ...
        #         mask0, mask1 = None, None
        #     if name == 'self':
        #         if self.use_checkpoint and feat0.requires_grad:
        #             feat0 = checkpoint(layer, feat0, feat0, mask0, mask0)
        #             # feat1 = layer(feat1, feat1, mask1, mask1)
        #             feat1 = checkpoint(layer, feat1, feat1, mask1, mask1)
        #         else:
        #             feat0 = layer(feat0, feat0, mask0, mask0)
        #             feat1 = layer(feat1, feat1, mask1, mask1)
        #     elif name == 'cross':
        #         if self.use_checkpoint and feat0.requires_grad:
        #             feat0 = checkpoint(layer, feat0, feat1, mask0, mask1)
        #             feat1 = checkpoint(layer, feat1, feat0, mask1, mask0)
        #             # feat1 = layer(feat1, feat0, mask1, mask0)
        #         else:
        #             feat0 = layer(feat0, feat1, mask0, mask1)
        #             feat1 = layer(feat1, feat0, mask1, mask0)
