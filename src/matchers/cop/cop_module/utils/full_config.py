...
# 1. CoP-backbone (local feature CNN) config
_CN.BACKBONE = CN()
_CN.BACKBONE.BLOCK_DIMS = [64, 128, 256]  # s1, s2, s3

# 2. CoP-coarse module config
_CN.COARSE = CN()
...
## 5. CoP-reconstruction config
_CN.RECONSTRUCTION_FEATURE = CN()
_CN.RECONSTRUCTION_FEATURE.INITIAL_DIM=128
_CN.RECONSTRUCTION_FEATURE.ENCODER_RECON_DIMS = [64, 128, 256]
